...
const steps = [
  ...
  { id: 'professional', title: 'Informations professionnelles' },
...
export default function InscriptionProfessionnelPage() {
  ...
  const validateStep = (step: number) => {
    ...
    if (step === 0) {
      ...
      else if (!/^\d{14}$/.test(formData.siret)) newErrors.siret = 'Le numéro SIRET doit contenir 14 chiffres'
      ...
      if (!formData.interventionArea) newErrors.interventionArea = 'La zone d\'intervention est requise'
      if (!formData.insuranceNumber) newErrors.insuranceNumber = 'Le numéro d\'assurance est requis'
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              {currentStep === 1 && (
                <div className="space-y-6">
                  ...
                  <div>
                    <label htmlFor="interventionArea" className="block text-sm font-medium text-gray-700">
                      Zone d'intervention
                    </label>
                    <div className="mt-1">
                      <input
                      ...
                      {errors.interventionArea && (
                        <p className="mt-2 text-sm text-red-600">{errors.interventionArea}</p>
                      )}
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="mt-1">
                      ...
                      {errors.insuranceNumber && (
                        <p className="mt-2 text-sm text-red-600">{errors.insuranceNumber}</p>
                      )}
                    </div>
                  </div>
